...
var _escapeTextContent = _interopRequireDefault(require("../../xml/escapeTextContent.js"));
...
var _getCellCoordinate = _interopRequireDefault(require("../helpers/getCellCoordinate.js"));
...
function getConditionalFormattingRulesXml(_ref4) {
  ...
  for (var _iterator = _createForOfIteratorHelperLoose(conditionalFormattingRules), _step; !(_step = _iterator()).done;) {
    ...
    var cellRange = (0, _getCellCoordinate["default"])(from.row - 1, from.column - 1) + ':' + (0, _getCellCoordinate["default"])(to.row - 1, to.column - 1);
    ...
    if (formula) {
      ...
      xml += "<formula>".concat((0, _escapeTextContent["default"])(formula), "</formula>");
      xml += '</cfRule>';
    } else if (operator) {
      xml += "<cfRule type=\"cellIs\" operator=\"".concat(getXlsxOperatorName(operator), "\" dxfId=\"").concat(dxfId, "\" priority=\"").concat(priority, "\">");
      xml += "<formula>".concat((0, _escapeTextContent["default"])(formatValue(value)), "</formula>");
      if (getXlsxOperatorName(operator) === 'between') {
        xml += "<formula>".concat((0, _escapeTextContent["default"])(formatValue(value2)), "</formula>");
      }
      xml += '</cfRule>';
    } else {
