...
function getFontXml(font) {
  ...
  if (fontFamily) {
    ...
    xml += "<name val=\"".concat((0, _escapeAttributeValue["default"])(fontFamily), "\"/>");
  }
  ...
  // Apply `textColor`
  if (textColor) {
    xml += "<color rgb=\"".concat((0, _escapeAttributeValue["default"])((0, _getXlsxColorForHexColor["default"])(textColor)), "\"/>");
  } else {
