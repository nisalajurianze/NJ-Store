...
var _hasFill = _interopRequireDefault(require("./hasFill.js"));
...
function getFillXml(fill) {
  ...
  xml += "<fgColor rgb=\"".concat((0, _escapeAttributeValue["default"])((0, _getXlsxColorForHexColor["default"])(isSolidFill ? backgroundColor : fillPatternColor)), "\"/>");
  xml += "<bgColor ".concat(isSolidFill && !conditionalFormatting ? 'indexed="64"' : 'rgb="' + (0, _escapeAttributeValue["default"])((0, _getXlsxColorForHexColor["default"])(backgroundColor)) + '"', "/>");
  xml += '</patternFill>';
...
//# sourceMappingURL=getFillXml.js.map