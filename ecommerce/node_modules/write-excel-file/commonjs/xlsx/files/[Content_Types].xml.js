...
exports["default"] = generateContentTypesXml;
exports.getDrawingContentTypeXml = getDrawingContentTypeXml;
...
var _excluded = ["sheetIds", "multipleSheetsParameters", "features"];
...
function generateContentTypesXml(_ref) {
  ...
  (0, _getAdditionalContent["default"])('[Content_Types].xml', features, restParameters, {
    multipleSheetsParameters: multipleSheetsParameters
  }) + '</Types>';

  // Apply any plugins that transform this XML.
  xml = (0, _transformContent["default"])(xml, '[Content_Types].xml', features, restParameters, {
    multipleSheetsParameters: multipleSheetsParameters
  });
  return xml;
}
