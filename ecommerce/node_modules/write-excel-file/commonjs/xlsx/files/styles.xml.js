...
var _escapeAttributeValue = _interopRequireDefault(require("../../xml/escapeAttributeValue.js"));
...
var _excluded = ["formats", "styles", "fonts", "fills", "borders"];
...
function generateStylesXml(parameters, multipleSheetsParameters, features) {
  var formats = parameters.formats,
    styles = parameters.styles,
    fonts = parameters.fonts,
    fills = parameters.fills,
    borders = parameters.borders,
    restParameters = _objectWithoutProperties(parameters, _excluded);
  ...
  if (formats.length > 0) {
    ...
    for (var i = 0; i < formats.length; i++) {
      xml += "<numFmt numFmtId=\"".concat(_initializeStyles.FORMAT_ID_STARTS_FROM + i, "\" formatCode=\"").concat((0, _escapeAttributeValue["default"])(formats[i]), "\"/>");
    }
    xml += "</numFmts>";
  }
  ...
  xml += (0, _getAdditionalContent["default"])('xl/styles.xml', features, restParameters, {
    multipleSheetsParameters: multipleSheetsParameters
  });
  xml += '</styleSheet>';

  // Apply any plugins that transform this XML.
  xml = (0, _transformContent["default"])(xml, 'xl/styles.xml', features, restParameters, {
    multipleSheetsParameters: multipleSheetsParameters
  });
  return xml;
}
