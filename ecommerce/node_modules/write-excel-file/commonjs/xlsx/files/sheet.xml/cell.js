...
function generateCell(rowNumber, columnIndex, value, type, cellStyleId, findOrCreateSharedString) {
  ...
  var cellAttributes = {
    r: (0, _getCellCoordinate["default"])(rowNumber - 1, columnIndex)
  };
  ...
  if (value === null) {
    return (0, _getSelfClosingTagMarkup["default"])('c', cellAttributes);
  }
  ...
  return (0, _getOpeningTagMarkup["default"])('c', cellAttributes) + openingTags + xlsxValue + closingTags + (0, _getClosingTagMarkup["default"])('c');
}
...
function getXlsxValue(type, value, findOrCreateSharedString) {
  ...
  switch (type) {
    ...
    case 'Formula':
      ...
      return (0, _escapeTextContent["default"])(value);
    default:
      throw new Error("Unknown schema type: ".concat(type && type.name || type));
  }
}
