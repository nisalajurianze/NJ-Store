import type { FooterQuickLinkDto, FooterSectionTitlesDto, FooterSettingsDto, FooterSocialLinksDto } from '@njstore/types';
...
export const defaultFooterSocialLinks = (): FooterSocialLinksDto => ({
  facebook: '',
  instagram: '',
  tiktok: '',
  youtube: '',
...
export const defaultFooterSectionTitles = (): FooterSectionTitlesDto => ({
  about: 'About',
...
export const defaultFooterQuickLinks = (): FooterQuickLinkDto[] => [
...
export const buildDefaultFooterSettings = (): FooterSettingsDto => ({
