...
const findOrCreateBrand = async (name: string, sortOrderSeed: number): Promise<{ id: Types.ObjectId; created: boolean }> => {
...
const normalizeLegacyBrandName = (brandValue: unknown, brandNameValue: unknown): string | null => {
