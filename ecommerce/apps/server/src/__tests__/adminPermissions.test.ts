...
describe('Admin permissions', () => {
  ...
  it(
    'enforces route permissions and picks up updated permissions without reissuing the access token',
    async () => {
  ...
  it(
    'returns analytics successfully for an admin with the required read permissions',
    async () => {
  ...
  it(
    'requires user read access for audit logs',
    async () => {
  ...
  it(
    'exports filtered audit logs as csv for admins with user read access',
    async () => {
  ...
  it(
    'allows an admin to safely restore their own user write permission after removing it',
    async () => {
  ...
  it(
    'prevents an admin from removing their own user-management permissions',
    async () => {
