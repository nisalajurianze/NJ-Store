...
const parseUserRoleFilter = (value: unknown): 'customer' | 'staff' | 'admin' | 'workspace' | undefined =>
  value === 'customer' || value === 'staff' || value === 'admin' || value === 'workspace' ? value : undefined;

const parseVerificationFilter = (value: unknown): 'verified' | 'unverified' | undefined =>
  value === 'verified' || value === 'unverified' ? value : undefined;

const parseBooleanFilter = (value: unknown): boolean => value === true || value === 'true';
