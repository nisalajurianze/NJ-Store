...
import { adminPermissions, type AdminPermission } from '@njstore/types';
...
const isSelfAdminPermissionRecoveryRequest = (req: Request): boolean => {
  ...
  const body = req.body as
    | Partial<{ role: 'customer' | 'staff' | 'admin'; isActive: boolean; permissions: AdminPermission[] }>
    | undefined;
...
export const restrictToPermissionOrSelfAdminRecovery =
