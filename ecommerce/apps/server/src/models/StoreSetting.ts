...
const footerSettingsSchema = new Schema(
  {
    ...
    mapEmbedUrl: {
      ...
      trim: true,
      validate: {
        validator: (value?: string | null) => !value || isAllowedMapEmbedUrl(value),
...
const storeSettingSchema = new Schema(
  {
    ...
    manualExpenses: {
      ...
      default: [],
      validate: {
        validator: (v: unknown[]) => v.length <= 500,
...
export const StoreSetting = model<StoreSettingDocument>('StoreSetting', storeSettingSchema);
