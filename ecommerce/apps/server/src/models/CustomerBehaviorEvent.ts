...
export type CustomerBehaviorEventDocument = InferSchemaType<typeof customerBehaviorEventSchema>;
export const CustomerBehaviorEvent = model<CustomerBehaviorEventDocument>('CustomerBehaviorEvent', customerBehaviorEventSchema);
