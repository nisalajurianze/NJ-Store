...
const optionalLoyaltyPointsSchema = z.preprocess(emptyStringToUndefined, z.coerce.number().int().min(0).optional());
...
export const confirmQuotationBodySchema = z.preprocess((value) => value ?? {}, z
    .object({
    paymentMethod: z.enum(['bank_transfer', 'cash_on_delivery']).optional(),
    type: z.enum(['delivery', 'pickup']).optional(),
    addressId: z.preprocess(emptyStringToUndefined, objectIdSchema.optional()),
