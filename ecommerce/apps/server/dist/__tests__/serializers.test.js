...
describe('serializeBrand', () => {
    it('normalizes Cloudinary logo URLs for brand rail display', () => {
        ...
        expect(serialized?.logoUrl).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_limit,w_480,h_192/v1710000000/njstore/brands/samsung.png');
    });
    it('replaces the generic Cloudinary image transform with the brand logo transform', () => {
        ...
        expect(serialized?.logoUrl).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_limit,w_480,h_192/v1710000000/njstore/brands/anker.png');
    });
    ...
    it('returns undefined instead of crashing when a brand reference is not populated', () => {
        const serialized = serializeBrand({ _id: 'brand-object-id-only' });
...
describe('serializeProductCard', () => {
    it('falls back to brandName when the brand reference is not populated', () => {
        const serialized = serializeProductCard({
            ...
            price: 67000,
            brand: { _id: 'brand-object-id-only' },
            brandName: 'HP',
    ...
    it('includes a compact transformed brand logo when the brand reference is populated', () => {
        ...
        expect(serialized.brandLogoUrl).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_limit,w_192,h_96/v1710000000/njstore/brands/apple.png');
    });
    it('normalizes Cloudinary product images for trimmed contain-fit display', () => {
        ...
        expect(serialized.thumbnail?.url).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_fit,w_320,h_320/v1710000000/njstore/products/iphone-17-pro.png');
        expect(serialized.previewImages?.[0]?.url).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_fit,w_720,h_720/v1710000000/njstore/products/iphone-17-pro.png');
    });
    ...
    it('uses variant media as the search suggestion thumbnail when product media is missing', () => {
        ...
        expect(serialized.thumbnail?.url).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_fit,w_320,h_320/v1710000000/njstore/products/iphone-17-pro-orange.png');
...
describe('serializeProductDetail', () => {
    it('preserves premium variant media fields while transforming Cloudinary images', () => {
        ...
        expect(serialized.variants[0]?.images?.[0]?.url).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_fit,w_1400,h_1400/v1710000000/njstore/products/iphone-17-pro-blue.png');
    });
});
...
describe('serializeBanner', () => {
    it('serializes the mid-page promo media while preserving video URLs and transforming images', () => {
        ...
        expect(serialized.featurePromo?.mediaItems?.[0]?.url).toBe('https://res.cloudinary.com/njstore/image/upload/f_auto,q_auto,w_800/v1710000000/njstore/banners/ai-tv-promo.png');
...
describe('serializeSiteConfig', () => {
    it('normalizes storefront logo URLs for crisp header rendering', () => {
        ...
        expect(serialized.storeLogo?.url).toBe('https://res.cloudinary.com/demo/image/upload/f_auto,q_auto,e_trim,c_limit,w_560,h_180/v1710000000/njstore/site-config/store-logo.png');
