...
const DEFAULT_DEV_MONGO_URI = `mongodb://${encodeURIComponent(DEFAULT_DEV_MONGO_USERNAME)}:${encodeURIComponent(DEFAULT_DEV_MONGO_PASSWORD)}@127.0.0.1:27017/njstore?authSource=admin&replicaSet=rs0`;
...
const canReachMongo = async (mongoUri) => {
    ...
    const portIsOpen = await new Promise((resolve) => {
