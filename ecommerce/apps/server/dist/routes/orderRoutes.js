...
import { cancelOrder, createReturnRequest, confirmQuotation, createQuotation, deleteReceiptFile, getQuotationByToken, getInvoice, getLegacyReceipt, getQuotation, getReceipt, getOrder, listReturnRequests, listOrders, uploadReturnEvidenceFiles, uploadReceiptFiles } from '../controllers/orderController.js';
import { protect } from '../middleware/auth.js';
import { uploadRateLimiter } from '../middleware/rateLimiter.js';
import { requireFile, uploadReceipt, uploadReturnEvidence } from '../middleware/upload.js';
import { validateBody, validateParams, validateQuery } from '../middleware/validate.js';
import { confirmQuotationBodySchema, confirmQuotationParamsSchema, createQuotationSchema, orderIdParamsSchema, orderListQuerySchema, orderReceiptParamsSchema } from '../validators/orderValidators.js';
