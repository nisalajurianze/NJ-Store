...
import { createExternalExpense, deleteExternalExpense, exportAnalyticsPdf, exportAuditLogs, exportSalesAnalysisPdf, getAnalytics, getBroadcastAudienceSummary, getSalesAnalysis, listAuditLogs, sendBroadcastEmail, updateExternalExpense } from '../../controllers/admin/index.js';
...
import { analyticsQuerySchema, auditLogExportQuerySchema, auditLogQuerySchema, broadcastEmailSchema, externalExpenseSchema, externalExpenseUpdateSchema, idParamsSchema } from '../../validators/adminValidators.js';
const router = Router();
...
router.patch('/sales-analysis/expenses/:id', restrictToPermission('setting:write'), adminActionRateLimiter, validateParams(idParamsSchema), validateBody(externalExpenseUpdateSchema), updateExternalExpense);
