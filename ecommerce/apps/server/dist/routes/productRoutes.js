...
import { askProductQuestion, getCompareProducts, getProduct, getPriceRange, listProductQuestions, getRecentlyViewed, getSuggestions, getUpsells, getUpsellProducts, getWishlist, listProducts, saveCompareList, subscribeToBackInStock, toggleWishlist, trackRecentlyViewed } from '../controllers/productController.js';
import { optionalAuth, protect } from '../middleware/auth.js';
import { searchRateLimiter, searchRateLimiterWhenQueryPresent } from '../middleware/rateLimiter.js';
import { validateBody, validateParams, validateQuery } from '../middleware/validate.js';
import { backInStockSubscriptionSchema, compareBodySchema, compareQuerySchema, productIdParamsSchema, productQuestionSchema, productPriceRangeQuerySchema, productQuerySchema, productSlugParamsSchema, productUpsellSchema, productUpsellQuerySchema, suggestionsQuerySchema } from '../validators/productValidators.js';
const router = Router();
...
router.post('/:id/back-in-stock-subscriptions', optionalAuth, validateParams(productIdParamsSchema), validateBody(backInStockSubscriptionSchema), subscribeToBackInStock);
